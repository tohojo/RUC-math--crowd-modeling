...
of motion. [Helbing and Molnár, 1995] %this should be made a REAL reference%
...
%	I think theese should be made into a subsubsection called comparison of model		%
...
rules to prevent these situations. [Pelechano et al., 2008] % use proper reference %
...
only move to free adjecent cells. [Pelechano et al., 2008] % use proper reference %
...
[Pelechano et al., 2008] % use proper reference %
\\
