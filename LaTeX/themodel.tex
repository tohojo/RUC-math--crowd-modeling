...
Therefore,  
\begin{align}
    \vec{f_{\alpha B}} \left( \vec{r_{\alpha}} \right) =&-\left( \frac{\partial \rho}{\partial x_{\alpha}}\frac{\partial}{\partial \rho}U^0_{\alpha B} e^{- \rho / r_{\alpha} }, \frac{\partial \rho}{\partial y_{\alpha}}\frac{\partial}{\partial \rho}U^0_{\alpha B} e^{- \rho / r_{\alpha} }\right) \\
=&\left( \dfrac{a^{2}x_{\alpha}+aby_{\alpha}+ac}{\sqrt{\left( a^{2}x_{\alpha}+aby_{\alpha}+ac \right) ^{2} + \left( b^{2}y_{\alpha}+abx_{\alpha}+bc\right) ^{2}}}   \frac{U^0_{\alpha B}}{r_{\alpha}} e^{- \rho / r_{\alpha} }, \\
& \dfrac{b^{2}y_{\alpha}+abx_{\alpha}+bc}{\sqrt{\left( a^{2}x_{\alpha}+aby_{\alpha}+ac \right) ^{2} + \left( b^{2}y_{\alpha}+abx_{\alpha}+bc\right) ^{2}}}   \frac{U^0_{\alpha B}}{r_{\alpha}} e^{- \rho / r_{\alpha} } \right)    
