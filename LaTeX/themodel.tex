...
initial speed the expression

% stats to yield strange results. This would mean that 
% $\eta_{\alpha} < 0$ which in turn means that:
% 
...
In the case where $1 < \eta_{\alpha}$ it would mean that the agent has 
