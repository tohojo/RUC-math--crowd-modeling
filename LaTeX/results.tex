...
\begin{figure}[ht]
    ...
    \subfloat[Clogging at the exit.]{
        \includegraphics[width=0.4\textwidth]{Figures/square_room_letters.png}
    ...
    \subfloat[Image from our simulations simulation]{
        \resizebox{0.3\textwidth}{!}{\input{Figures/time-to-clear-room.tex}}
        \label{subfig:clear-room-ours}
    }
    \subfloat[Time to clear the room as a function of mean desired velocity.]{
        \includegraphics[width=0.6\textwidth]{Figures/time-to-clear.pdf}
        \label{subfig:time-to-clear-plot}
    }
    \caption[Faster-is-slower effect]{Faster-is-slower 
    effect. \subref{subfig:fast-slow-clogging} and 
    \subref{subfig:fast-slow-graph}  from \cite{helbing00}, 
    \subref{subfig:clear-room-ours} and \subref{subfig:time-to-clear-plot} the 
    corresponding data from our simulation.}
