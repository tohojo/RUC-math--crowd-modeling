...
\begin{figure}
\centering
\subfloat[The figure show the density in corridor when the parameters are set as \cite{ABconstants} and \cite{self-org}.]{\includegraphics[scale=0.45]{Figures/dens_init_20.pdf}}
\subfloat[This figure shows the density in the corridor when the max velocity factor is set to $4.0$]{\includegraphics[scale=0.45]{Figures/dens_mvel4_20.pdf}}
