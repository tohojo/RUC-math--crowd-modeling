...
\begin{figure}
\centering
\subfloat[Overlapping occurs when speeds get to high in this case $2.50m/s$ which prevents pedestrians from stopping in time.]{\includegraphics[scale=0.5]{Figures/init_75_dens.pdf}}
\subfloat[A single pedestrian escapes throw the wall due to a initial speed of $3.50m/s$]{\includegraphics[scale=0.5]{Figures/dens_75_3ms.pdf}}
