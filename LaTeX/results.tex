...
\begin{figure}[h]
\centering
\subfloat[]{\includegraphics[scale=0.25]{Figures/normalcorridor.png}}
\subfloat[]{\includegraphics[scale=0.25]{Figures/Widespace.png}}
\caption{}
...
in shown in figure \ref{fig:is-faster-slower}
