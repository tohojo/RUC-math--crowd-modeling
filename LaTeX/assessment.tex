...
% TODO: This section should be high-level additions (navigation, 
% decision-making etc) instead of low-level changes. It is already high level 
% but state it explicitly in the beginning.
...
agents can not necessarily see the waypoint. %TODO: find reference
...
% Add the stuff about the parameter. Do we need to tweek the paramaters each time.
...
% \subsubsection{Articles} TODO: Wriggle this into the introduction.
