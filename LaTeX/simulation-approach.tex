...
\begin{itemize}
    ...
    \item \textbf{Flow rate:} Flow rate is measured along a line segment 
        ...
        away from it. This is used as an approximation of when the actors 
        cross the line. The average flow rate is then computed as the number 
        of actors who have crossed the line divided by the time. This is 
        graphed both as a function of time, and as a function of parameters. 
        The flow rate value of a whole simulation run is calculated as the 
        average of the flow rate measurements over time.
