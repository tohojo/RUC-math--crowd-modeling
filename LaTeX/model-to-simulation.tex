...
outlined above, and then only vary parameters when the simulation does not 
look realistic. While this does not give us an exhaustive overview of the model 
behaviour, it is sufficient to test whether or not we see the phenomena we are 
trying to reproduce.
