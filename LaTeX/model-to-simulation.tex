...
Also, the results that we wish to replicate are often given as screen shots so 
we are not interesting in know what parameters that give the best lane 
formation or oscillatory flow, were just interested in actually seeing the 
phenomena.
