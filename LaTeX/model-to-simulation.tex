...
sure that the pedestrians dont go through each other and the wall, which 
would be a very time comsuming and tedious task or we would have to 
write a lot of code checkking for such errors and discarding the 
...
not a given simulation gives meaningfull results that reflect 
